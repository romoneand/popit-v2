...
Section:NewToggle("Auto Dupe Pop it {1.2Bil Cash Required}"  , "Dupe Pop It Rainbow", function(state)
    if state then
        _G.on = true
        ...
        Section:NewToggle("Auto Dupe Lolly {600M Cash Required}"  , "Dupe Lolly rainbow", function(state)
            if state then
                _G.on = true
...
Section:NewToggle("Auto Dupe amogus {400M Cash Required}" , "Dupe Amogus", function(state)
    if state then
        _G.on = true
        ...
        _G.on = false
                        ...
                        Section:NewToggle("Auto crystal Rb {200M Cash Required}"  , "Dupe crystal", function(state)
                            if state then
                                _G.on = true
                                ...
                                _G.on = false
                                        ...
                                        Section:NewToggle("Auto dupe Gummy rainbow {40M Cash Required}"  , "Dupe gummy", function(state)
                                            if state then
                                                _G.on = true
                ...
                Section:NewToggle("Auto Dupe gem Rainbow {34M Cash Required}"  , "Dupe Gem rainbow", function(state)
                    if state then
                        _G.on = true
...
local Tab     = Window:NewTab("anti reaper")
                local Section = Tab:NewSection("this Tab is for the annoying reaper")
                                                        ...
                                                        Section:NewToggle("anti reaper make sure you have alot of Watermelon"  , "Equips Watermelon", function(state)
                                                            if state then
                                                                _G.on = true
...
local Tab     = Window:NewTab("Update Credits")
                local Section = Tab:NewSection("Made by romlnwza007#3770")
                local Section =
Tab:NewSection ("Discord| .gg/r2P6xbUfnV")
